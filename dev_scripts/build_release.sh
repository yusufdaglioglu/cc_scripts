...
source "./dev_exception_handler.sh" || exit 254
source "./dev_print_utils.sh" || exit 253
source "./../src/core_shell_utils/cc_exit_code.sh" || exit 252
...
export CC_SCRIPTS_PROJECT_VERSION=29
