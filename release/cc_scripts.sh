...
# URL: https://github.com/yusufdaglioglu/cc_scripts
...
c_find_text_inside_files_HELP_ONLY() {
   ...
   ___print_screen 'simple regex examples https://github.com/yusufdaglioglu/tutorials/blob/master/tutorials/regex.md#regex-kullan%C4%B1m%C4%B1'
   ___print_screen
   ___print_screen
...
c_tor_browser() {
   ...
   # detach is param of tor-browser itself.
...
c_media_file_manipulation_HELP_ONLY() {
   ...
   ___print_screen 'ffmpeg -i input_file.mp4 -c copy -ss 00:10:00 -t 00:11:00 output_1_minute_part.mp4'
   ___print_screen
